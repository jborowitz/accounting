...
**Status**: `todo` | **Effort**: L | **PDF Ref**: Flow A (final step), Section 5 (Controls/audit), Section 7
...
**Status**: `todo` | **Effort**: L | **PDF Ref**: Flow A step 6, Section 5 (Accruals)
...
**Status**: `todo` | **Effort**: M | **PDF Ref**: Flow A step 7
...
**Status**: `todo` | **Effort**: M | **PDF Ref**: Flow B (Gross Commission Attribution)
...
| **Accrual & True-Up** | ❌ Gap | **1.6 (new)** |
| **Journal Output / GL Posting** | ❌ Gap | **1.7 (new)** |
| **Audit Trail + Recalc Log** | ❌ Gap | **1.5** |
...
| **Gross Commission Attribution** | ❌ Gap | **3.1** |
| **Netting & Adjustments** | ❌ Gap | **3.3 (new)** |
| **Payout File + Accrual File** | ❌ Gap | **2.2** |
...
| Accruals | ❌ Gap | **1.6 (new)** |
| Controls/audit | ❌ Gap | **1.5** |
